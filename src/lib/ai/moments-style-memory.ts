...
export const XIAOHONGSHU_STYLE_MEMORY = [
  ...
  "语言口语化、有网感，但不是廉价热词堆砌；常用即时感、反差感、真实发现和轻感叹来制造入口。",
